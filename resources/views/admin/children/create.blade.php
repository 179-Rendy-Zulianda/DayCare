...
<div class="max-w-3xl mx-auto p-6 bg-white/90 rounded-2xl shadow-2xl mt-8 mb-8">
    ...
    @endif
    <form method="POST" action="{{ route('admin.children.store') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="mt-8 text-center">
            <button type="submit" class="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-bold px-8 py-3 rounded-full shadow-lg transition-all duration-300">Daftarkan Anak</button>
        </div>
    </form>
</div>
@endsection 